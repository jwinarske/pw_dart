...
struct glz::meta<pw_dart::LinkInfo> {
    ...
    static constexpr auto value = object(
        "id", &T::id,
        "output_node_id", &T::output_node_id,
        "output_port_id", &T::output_port_id,
        "input_node_id", &T::input_node_id,
        "input_port_id", &T::input_port_id,
        "state", &T::state,
        "error", &T::error,
        "properties", &T::properties
    );
...
struct glz::meta<pw_dart::NodeRemovedEvent> {
    ...
    static constexpr auto value = object("type", &T::type, "node_id", &T::node_id);
};
...
struct glz::meta<pw_dart::PortRemovedEvent> {
    ...
    static constexpr auto value = object("type", &T::type, "port_id", &T::port_id);
};
...
struct glz::meta<pw_dart::LinkRemovedEvent> {
    ...
    static constexpr auto value = object("type", &T::type, "link_id", &T::link_id);
};
