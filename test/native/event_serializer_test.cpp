...
TEST(EventSerializerTest, SerializeAndDeserializeSnapshot) {
  GraphSnapshot snap;
  snap.nodes.push_back({.id = 1,
                        .name = "node1",
                        .media_class = "Audio/Sink",
                        .state = "running"});
  snap.nodes.push_back({.id = 2,
                        .name = "node2",
                        .media_class = "Audio/Source",
                        .state = "idle"});
  snap.ports.push_back(
      {.id = 10, .node_id = 1, .name = "port1", .direction = "output"});
  snap.links.push_back({.id = 100,
                        .output_node_id = 1,
                        .output_port_id = 10,
                        .input_node_id = 2,
                        .input_port_id = 20,
  ...
  snap.devices.push_back(
      {.id = 200, .name = "ALSA", .media_class = "Audio/Device"});
