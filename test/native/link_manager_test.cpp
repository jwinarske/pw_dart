...
TEST(LinkManagerTest, LinkSnapshotRoundTrip) {
    ...
    snap.links.push_back({
        .id = 1, .output_node_id = 10, .output_port_id = 100,
        .input_node_id = 20, .input_port_id = 200, .state = "active"
    });
    snap.links.push_back({
        .id = 2, .output_node_id = 30, .output_port_id = 300,
        .input_node_id = 40, .input_port_id = 400, .state = "paused"
    });
